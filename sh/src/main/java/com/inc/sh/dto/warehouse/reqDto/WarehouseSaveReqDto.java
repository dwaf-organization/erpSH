...
@AllArgsConstructor
@Builder
public class WarehouseSaveReqDto {
    
    private List<WarehouseItemDto> warehouses;  // 창고 배열
    
    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    @Builder
    public static class WarehouseItemDto {
        private Integer warehouseCode;          // null=CREATE, 값=UPDATE
        private Integer distCenterCode;         // 물류센터코드 (필수)
        private Integer hqCode;                 // 본사코드 (필수)
        private String warehouseName;           // 창고명 (필수)
